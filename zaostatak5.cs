...
namespace ConsoleApp1
{
    ...
    class FoodType
    {
        ...
        {
            return String.Format("banana: p - {0}%, c - {1}%, f - {2}%", protein, carbs, fat);
        }
    ...
    class Food
    {
        ...
        {
            return String.Format("banana: p - {0}g, c - {1}g, f - {2}g, w - {3}g", getProtein(), getCarbs(), getFat(),
                                 weight);
        }
    }
}
